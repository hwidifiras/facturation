...
function InvoiceForm() {
  ...
  return (
    <>
      ...
      <div className="invoice-container">
        ...
        <div className="totals-bank-section">
          <div className="payment-info">
            <h2>{formData.documentType === 'facture' ? 'RÈGLEMENT :' : 'INFORMATIONS :'}</h2>
      ...
      {/* Add button moved outside the invoice container */}
      <div className="no-print button-container" style={{ marginTop: '20px', textAlign: 'center' }}>
        <button
          className="add-item tooltip"
          onClick={addItem}
